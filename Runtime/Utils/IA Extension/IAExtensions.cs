...
namespace IA.Utils
{
    ...
    {
        public static bool ThisStringIsEqualTo(this string thisString, string otherString) =>
        ...
        /// <summary>
        /// Target index Greater than Max Index return 0
        /// Target index Smaller than 0 return Max Index
        /// When Top conditions not worked return Same Index
        /// </summary>
        /// <param name="value">Input value</param>
        /// <param name="_maxIndex">Maximum Value</param>
        /// <returns></returns>
        public static int RoundIndex(this int value, int _maxIndex)
        {
            int outputIndex = value > _maxIndex ? 0 :
                              value < 0 ? _maxIndex : value;
        ...
        public static bool TryAdd<T>(this List<T> targetList, T item)
        {
            bool itemExistInList = targetList.Exists(x => x.Equals(item));
        ...
        public static Coroutine StartCoroutine(this IEnumerator ienum, string go_Name = "Coroutine Starter")
        {
            GameObject coroutineStarterGO = new GameObject(go_Name);
        ...
        /// <param name="checkGameObjectIsActive">Check Target GameObject is Active on Scene \nNOTE: if it is false, function will call directly StartCoroutine without check GameObject Active State</param>
        /// <returns>Coroutine</returns>
        public static Coroutine StartCoroutine(this IEnumerator ienum, MonoBehaviour coroutineStarter, bool checkGameObjectIsActive = true)
        {
            if (checkGameObjectIsActive)
            {
        ...
        public static bool Is_CTRL_D_Pressed(this Event e)
        {
            if (e != null)
            {
        ...
        public static bool IsDuplicate(this Event e)
        {
            if (e != null)
            {
                ...
                e.type == EventType.ExecuteCommand && e.commandName == "Paste";
            }

            return false;
        }

        public static bool IsDeletePressed(this Event e)
        {
            if (e != null)
            {
        ...
        public static bool Is_CTRL_S_Pressed(this Event e)
        {
            if (e != null)
            {
